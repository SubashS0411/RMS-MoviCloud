...
function SidebarContent({
  ...
  return (
    <div className="space-y-4 bg-white/95 backdrop-blur-md p-3.5 sm:p-4 rounded-2xl border border-border shadow-[0_8px_24px_rgba(62,39,35,0.08)]">
      <div>
        <div className="flex items-center gap-2 mb-2.5 px-1">
          <div className="p-1.5 bg-primary/10 rounded-md">
            <Filter className="w-3.5 h-3.5 text-primary" />
          </div>
          <span className="font-semibold text-foreground text-sm">Browse Categories</span>
        </div>
            ...
            <button
              ...
              className={`group w-full text-left px-3 py-2 rounded-lg border transition-all duration-200 font-semibold text-[11px] uppercase tracking-wide ${
                selectedCategory === category
                  ? 'bg-primary text-white border-primary shadow-sm shadow-[#8B5A2B]/30'
                  : 'bg-[#FCFAF7] text-muted-foreground border-border hover:border-[#C8A47A] hover:bg-[#F8F2EA] hover:text-[#5A3D2A]'
              }`}
          ...
          <button
            ...
            className={`w-full text-left px-3 py-2 rounded-lg border transition-all font-semibold uppercase tracking-wide text-[11px] ${
              filterVeg === 'all'
                ...
                : 'bg-[#FCFAF7] text-muted-foreground border-border hover:border-[#3E2723]/40 hover:bg-[#F8F2EA]'
            }`}
          >
            All
          </button>
          <button
            ...
            className={`w-full text-left px-3 py-2 rounded-lg border transition-all font-semibold uppercase tracking-wide text-[11px] ${
              filterVeg === 'veg'
                ...
                : 'bg-[#FCFAF7] text-muted-foreground border-border hover:border-green-700 hover:text-green-700 hover:bg-[#F8F2EA]'
            }`}
          >
            Veg
          </button>
          <button
            ...
            className={`w-full text-left px-3 py-2 rounded-lg border transition-all font-semibold uppercase tracking-wide text-[11px] ${
              filterVeg === 'non-veg'
                ...
                : 'bg-[#FCFAF7] text-muted-foreground border-border hover:border-red-700 hover:text-red-700 hover:bg-[#F8F2EA]'
            }`}
          >
            Non-Veg
          </button>
          <button
            ...
            className={`w-full text-left px-3 py-2 rounded-lg border transition-all font-semibold uppercase tracking-wide text-[11px] flex items-center gap-2 ${
              filterVeg === 'special'
                ...
                : 'bg-[#FCFAF7] text-muted-foreground border-border hover:border-[#C8A47A] hover:text-primary hover:bg-[#F8F2EA]'
            }`}
          >
    ...
    <>
      <div className="lg:hidden mb-3">
        <button
          ...
          className="inline-flex items-center gap-2 px-3.5 py-2 rounded-lg border border-border bg-white/95 text-foreground text-xs font-semibold shadow-sm"
        >
      ...
      {open && (
        <div className="fixed inset-0 z-50 lg:hidden">
          ...
          />
          <div className="absolute left-0 top-0 h-full w-[84%] max-w-sm bg-background p-3.5 overflow-y-auto shadow-2xl">
            <div className="flex items-center justify-between mb-3">
              <h3 className="text-sm font-semibold text-foreground">Filters</h3>
              <button
                onClick={() => setOpen(false)}
                className="p-1.5 rounded-md bg-white border border-border text-foreground"
                aria-label="Close"
              >
                <X className="w-4 h-4" />
              </button>
